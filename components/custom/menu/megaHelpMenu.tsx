  ...
  return (
    <div className=" flex flex-col w-full h-full sm:flex md:flex">
      <div className="relative">
        <div
          className={`w-32 bg-blue-400 text-white flex gap-4 my-2 py-1.5 px-4 hover:cursor-pointer rounded-full font-semibold`}
      ...
      <Modal
        ...
        className="bg-[#F3F4F6] p-0 rounded sm:top-0 sm:mx-1 sm-w-full md:top-1 md:mx-2 md:w-full lg:top-2 lg:mx-3 xl:top-4 xl:ml-[19rem]"
        onOk={() => setOpen(false)}
